...
nagios_command 'notify_service_by_slack' do
  options 'command_line' => '/usr/bin/service_notify_slack'
end

nagios_command 'notify_host_by_slack' do
  options 'command_line' => '/usr/bin/host_notify_slack'
end
